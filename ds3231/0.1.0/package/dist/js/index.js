...
var Reg;
(function (Reg) {
    Reg[Reg["Seconds"] = 0] = "Seconds";
    Reg[Reg["Minutes"] = 1] = "Minutes";
    Reg[Reg["Hours"] = 2] = "Hours";
    Reg[Reg["Day"] = 3] = "Day";
    Reg[Reg["Date"] = 4] = "Date";
    Reg[Reg["Month"] = 5] = "Month";
    Reg[Reg["Year"] = 6] = "Year";
    Reg[Reg["TempMsb"] = 17] = "TempMsb";
    Reg[Reg["TempLsb"] = 18] = "TempLsb";
})(Reg || (Reg = {}));
...
export class DS3231 {
     ...
     */
    constructor(bus, address = DEFAULT_ADDRESS) {
        this.bus = bus;
        this.addr = address;
    }
    /**

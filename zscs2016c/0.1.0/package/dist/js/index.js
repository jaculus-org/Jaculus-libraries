...
export class ZSCS2016C {
     ...
     * @returns uint8 Rgb color (format 0xRRGGBB)
     */
    readRgb() {
        let value = this.readRawRgb();
        return rgb(map(value[0], this.cal.mins[0], this.cal.maxs[0], 0, 255), map(value[1], this.cal.mins[1], this.cal.maxs[1], 0, 255), map(value[2], this.cal.mins[2], this.cal.maxs[2], 0, 255));
    }
    /**

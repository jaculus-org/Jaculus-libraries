 ...
 */
export function linearize(color) {
    const r = (color >> 16) & 0xff;
    const g = (color >> 8) & 0xff;
    const b = color & 0xff;
 ...
 */
export function stretchChannels(color, maxR, maxG, maxB) {
 ...
 * @returns Stretched RGB color (format 0xRRGGBB)
 */
export function stretchChannelsEvenly(color, max) {
...
export function rainbow(hue, brightness = 50) {
    ...
    return hslToRgb(hue, 100, brightness_mapped);
}

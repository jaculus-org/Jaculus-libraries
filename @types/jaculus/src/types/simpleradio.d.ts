declare module "simpleradio" {
    ...
    function on(
        type: "number",
        callback: (num: number, info: PacketInfo) => void,
    ): void;
    ...
    function on(
        type: "string",
        callback: (str: string, info: PacketInfo) => void,
    ): void;
    ...
    function on(
        type: "keyvalue",
        callback: (key: string, value: number, info: PacketInfo) => void,
    ): void;
    ...
    function on(
        type: "blob",
        callback: (data: Uint8Array, info: PacketInfo) => void,
    ): void;
